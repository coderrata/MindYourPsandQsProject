        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Objectives_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StepId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AStep = table.Column<string>(nullable: false),
                    ObjectiveId = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    UpdatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Steps_Objectives_ObjectiveId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Objectives_LanguageId",
                table: "Objectives",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_Steps_ObjectiveId",
                table: "Steps",
                column: "ObjectiveId");
        }
